...
public class A_Sweet_Problem {
 public static void main(String[] args) {
  ...
  while (t-- > 0) {
   ...
   Collections.sort(colors, Comparator.reverseOrder());
 
   if (colors.get(0) >= colors.get(1) + colors.get(2))
    out.println(colors.get(1) + colors.get(2));
   else
    out.println((colors.get(0) + colors.get(1) + colors.get(2)) / 2);
  }
  out.close();
 }
