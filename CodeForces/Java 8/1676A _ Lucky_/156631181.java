...
public class A_Lucky {
 public static void main(String[] args) {
  ...
  while (tc-- > 0) {
   String t = sc.next();
    if(Integer.parseInt(String.valueOf(t.charAt(0)))+Integer.parseInt(String.valueOf(t.charAt(1)))+Integer.parseInt(String.valueOf(t.charAt(2)))
     == Integer.parseInt(String.valueOf(t.charAt(3)))+Integer.parseInt(String.valueOf(t.charAt(4)))+Integer.parseInt(String.valueOf(t.charAt(5))))
     out.println("YES");
   else out.println("NO");
  }
  out.close();
