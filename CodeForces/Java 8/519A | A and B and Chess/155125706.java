...
public class A_A_and_B_and_Chess {
 public static void main(String[] args) {
  MyScanner sc = new MyScanner();
  out = new PrintWriter(new BufferedOutputStream(System.out));
 
  // the queen's weight is 9, Q
  // the rook's weight is 5, R
  // the bishop's weight is 3, B
  // the knight's weight is 3, N
  // the pawn's weight is 1, P
  // the king's K
  ...
  for (int i = 0; i < s.length(); i++) {
   if (s.charAt(i) == 'Q') white += 9;
   else if (s.charAt(i) == 'R') white += 5;
   else if (s.charAt(i) == 'B' || s.charAt(i) == 'N') white += 3;
   else if (s.charAt(i) == 'P') white += 1;
   else if (s.charAt(i) == 'q') black += 9;
   else if (s.charAt(i) == 'r') black += 5;
   else if (s.charAt(i) == 'b' || s.charAt(i) == 'n') black += 3;
   else if (s.charAt(i) == 'p') black += 1;
  }
 
  if(white == black) out.println("Draw");
  else if(white>black) out.println("White");
