...
public class A_Sleuth {
 public static void main(String[] args) {
  ...
  String[] letters = sc.nextLine().toLowerCase().replaceAll("[? ]", "").split("");
  //out.println(letters[letters.length - 1]);
  if (letters[letters.length - 1].equals("a") || letters[letters.length - 1].equals("e")
    || letters[letters.length - 1].equals("i") || letters[letters.length - 1].equals("u")
    || letters[letters.length - 1].equals("o") || letters[letters.length - 1].equals("y"))
   out.println("YES");
  else
   out.println("NO");
  out.close();
