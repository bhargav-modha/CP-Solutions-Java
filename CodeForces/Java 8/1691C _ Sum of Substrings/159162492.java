...
public class C_Sum_of_Substrings {
 public static void main(String[] args) {
  ...
  while (t-- > 0) {
   ...
   int ones = 0, first_1 = n, last_1 = -1;
   first_1 = String.valueOf(arr).indexOf('1');
   last_1 = String.valueOf(arr).lastIndexOf('1');
   ones = count(String.valueOf(arr), '1');
   int add = 0;
   if (ones > 0 && (n - 1 - last_1) <= k) {
    k -= (n - 1 - last_1);
    add++;
    ones--;
   }
