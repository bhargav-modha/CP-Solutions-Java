...
public class B_Binary_String_Constructing {
 public static void main(String[] args) {
  MyScanner sc = new MyScanner();
  out = new PrintWriter(new BufferedOutputStream(System.out));
  int a = sc.nextInt(), b = sc.nextInt(), x = sc.nextInt();
  // a zeros, b one and x indices
  StringBuilder sb = new StringBuilder();
  if (x % 2 == 0) {
   if (a > b) {
    for (int i = 0; i < x / 2; i++) sb.append("01");
     for (int i = 0; i < b-(x/2); i++) sb.append("1");
     for (int i = 0; i < a-(x/2); i++) sb.append("0");
   } else {
    for (int i = 0; i < x / 2; i++) sb.append("10");
    for (int i = 0; i < a-(x/2); i++) sb.append("0");
    for (int i = 0; i < b-(x/2); i++) sb.append("1");
   }
  } else if (a > b) {
 ...
 static void swap(StringBuilder a, int l, int r) {
