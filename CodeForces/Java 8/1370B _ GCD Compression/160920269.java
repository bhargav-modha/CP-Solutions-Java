...
public class B_GCD_Compression {
 public static void main(String[] args) {
  ...
  while (t-- > 0) {
   ...
   TreeSet<Integer> oddset = new TreeSet<>(), evenSet = new TreeSet<>();
   ...
   for (int i = 0; i < n - 1; i++) {
    if (oddset.size() >= 2) {
     out.print(oddset.first());
     oddset.remove(oddset.first());
     out.print(" " + oddset.first());
     oddset.remove(oddset.first());
    } else if (evenSet.size() >= 2) {
     out.print(evenSet.first());
     evenSet.remove(evenSet.first());
     out.print(" " + evenSet.first());
     evenSet.remove(evenSet.first());
    }
    out.println();
