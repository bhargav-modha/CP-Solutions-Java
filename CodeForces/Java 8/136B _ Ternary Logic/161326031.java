...
public class B_Ternary_Logic {
 public static void main(String[] args) {
  MyScanner sc = new MyScanner();
  out = new PrintWriter(new BufferedOutputStream(System.out));
  int a = sc.nextInt(), c = sc.nextInt();
  StringBuilder A = new StringBuilder(Integer.toString(a, 3)), C = new StringBuilder(Integer.toString(c, 3));
  ...
  out.println(Integer.parseInt(String.valueOf(ans), 3));
  out.close();
 }
